...
public class CustomerController {
    ...
    public ResponseEntity<ApiResponse> getCustomers() {
        ...
        return ResponseEntity.status(OK)
                .body(new ApiResponse("All customers retrieved successfully", customers));
    }
    ...
    public ResponseEntity<ApiResponse> getCustomerAccounts(@PathVariable Long customerId) {
        ...
        if(accounts.isEmpty()){
            return ResponseEntity.status(NOT_FOUND)
                .body(new ApiResponse("No account found", null));
        }
        return ResponseEntity.status(OK)
                .body(new ApiResponse("All the customer's accounts have been retrieved", accounts));
    }
    ...
    public ResponseEntity<ApiResponse> addCustomer(@RequestParam Long personId) {
        ...
        return ResponseEntity.status(CREATED)
                .body(new ApiResponse("The customer with person id: " + personId + " successfully created", null));
    }
    ...
    public ResponseEntity<ApiResponse> blockCustomer(@RequestParam Long customerId){
        ...
        return ResponseEntity.status(ACCEPTED)
            .body(new ApiResponse("The customer has successfully blocked", null));
    }
}
