...
public class PersonController {
    ...
    public ResponseEntity<ApiResponse> createPerson(@Valid @RequestBody RequestAddNewPerson person) {
        ...
        return ResponseEntity.status(CREATED).body(new ApiResponse("Person successfully inserted", null));
    }
    ...
    public ResponseEntity<ApiResponse> getPersonById(@PathVariable Long personId) {
        ...
        return ResponseEntity.ok().body(new ApiResponse("Person successfully retrieved", person));
    }
